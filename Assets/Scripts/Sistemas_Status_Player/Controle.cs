...
public class Controle : MonoBehaviour
{
    ...
    [Range(1, 15)]
    public float AlturaQueda = 50, DanoPorMetro = 8;
    ...
    void Start()
    {
        ...
        velocidadeCaminhando = Jogador.GetComponent<Player>().forwardSpeed;
        velocidadeCorrendo = Jogador.GetComponent<Player>().strafeSpeed;
    }
    void Update()
    {
        SistemaDeQueda();
    ...
    void SistemaDeEstamina()
    {
        ...
        {
            EstaminaAtual = 0;
            Jogador.GetComponent<Player>().forwardSpeed = velocidadeCaminhando;
            semEstamina = true;
        }
        if (semEstamina == true && EstaminaAtual >= (EstaminaCheia * 0.15f))
        {
            Jogador.GetComponent<Player>().forwardSpeed = velocidadeCorrendo;
            semEstamina = false;
        }
    ...
    void Morreu()
    {
        Debug.Log("VOCÊ MORREU: Danos causados");
